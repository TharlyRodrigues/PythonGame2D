...
plane_img = pygame.image.load(resource_path('Assets/planes.png'))
logo_img = pygame.image.load(resource_path('Assets/logo.png'))
fighter_img = pygame.image.load(resource_path('Assets/fighter.png'))
clouds_img = pygame.image.load(resource_path('Assets/clouds.png'))
clouds_img = pygame.transform.scale(clouds_img, (WIDTH, 350))

home_img = pygame.image.load(resource_path('Assets/homeBtn.png'))
replay_img = pygame.image.load(resource_path('Assets/replay.png'))
sound_off_img = pygame.image.load(resource_path("Assets/soundOffBtn.png"))
sound_on_img = pygame.image.load(resource_path("Assets/soundOnBtn.png"))
...
game_over_font = resource_path('Assets/ghostclan.ttf')
tap_to_play_font = resource_path('Assets/BubblegumSans-Regular.ttf')
score_font = resource_path('Assets/DalelandsUncialBold-82zA.ttf')
final_score_font = resource_path('Assets/DroneflyRegular-K78LA.ttf')
...
tap_to_play_msg = tap_to_play = BlinkingText(WIDTH//2, HEIGHT-60, 25, "Toque para jogar",
                 tap_to_play_font, WHITE, win)


# SOUNDS **********************************************************************

player_bullet_fx = pygame.mixer.Sound(resource_path('Assets/gunshot.wav'))
click_fx = pygame.mixer.Sound(resource_path('Assets/click.mp3'))
collision_fx = pygame.mixer.Sound(resource_path('Assets/mini_exp.mp3'))
blast_fx = pygame.mixer.Sound(resource_path('Assets/blast.wav'))
fuel_fx = pygame.mixer.Sound(resource_path('Assets/fuel.wav'))

pygame.mixer.music.load(resource_path('Assets/Defrini - Spookie.mp3'))
